        ...
        <div className='w-full bg-white mt-6 rounded-2xl p-7 '>
            <div className='flex justify-between items-center'>
                ...
                <div>
                    ...
                    <Button onClick={()=>onCopyLInk()} className='mt-2'> <Copy/>Copy link</Button>
                </div>
                <hr className='my-7'/>

                <div className='flex gap-5'>
                    <h2 className='flex gap-2 items-center '><Clock className='h-4 w-4'/>{formdata?.duration}</h2>
                    <h2 className='flex gap-2 items-center '><List className='h-4 w-4'/>10 Question</h2>
                    {/* <h2 className='flex gap-2 items-center '><Clock className='h-4 w-4'/>{formdata?.duration}</h2> */}
                </div>
        </div>
